...
function compose_file(read_file_path::String, base_file_name::String, aux_file_name::String, file_ext::String)
    ...
    base_file = readdlm(read_file_path * base_file_name * file_ext)
    aux_cols = readdlm(read_file_path * aux_file_name * file_ext)
...
function compose_file(read_file_path::String, base_file_name::String, aux_file_name::NTuple{N, String}, file_ext::NTuple{N, String}) where {N}
